...
public class GoToMainPageFromLkWithLogoTest {
    ...
    @DisplayName("Переход из личного кабинета на главную страницу через нажатие лого")
    public void GoToMainPageFromLkByClickingLogo() {
     ...
     //   sleep(2000);
        ...
        lkPage.clicklogoStellarisBurgers();
        mainPage.waitForLoadMainPage();
     //   sleep(2000);
